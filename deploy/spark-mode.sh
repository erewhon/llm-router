...
start_default_archimedes() {
    local model="Qwen/Qwen3-Coder-Next-FP8"
...
start_big() {
    ...
    # Disable Ray compiled DAG — causes intermittent hangs on GB10 unified memory
    docker_common+=" -e RAY_USE_COMPILED_DAG=0 -e VLLM_USE_RAY_COMPILED_DAG=0"
