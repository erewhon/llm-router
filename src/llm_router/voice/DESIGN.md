...
- [ ] Slice 5 — live mic/speaker frontend (continuous audio I/O; v1 is file/turn-driven); barge-in; auto-router-based trigger; deploy orchestrator as a hypatia service.
